...
const Infor = ({
	...
	useEffect(() => {
		...
		dataBookSeat.username && dataBookSeat.phonenumber && dataBookSeat.email,
	]);
		...
		<Wrapper>
			<div className="my-[1rem] ml-[-2rem] block ">
				<div className="title w-[70%]">
					Chúng tôi chỉ dùng thông tin của bạn trong việc ghi nhận vé.
				</div>
				<div className="mt-4">
					<p className="font-bold">
						Họ tên <span className="text-red-600">*</span>
					</p>
					<input
						type="text"
						className="mt-[-15px]"
				...
				{inValidData.errRequire ? (
					<p className="text-red-600 mb-0 mb-[-15px] text-[10px] mt-2">
						{" "}
						{inValidData.errRequire}
					</p>
				) : (
				...
				<p className="mt-2 mb-8">
					...
					<span className="text-[#2a41e8]  ">
						Chính sách bảo mật thông tin và Quy chế{" "}
					</span>
				</p>
