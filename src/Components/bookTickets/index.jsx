...
const BookTickets = ({ isClickBook, item, ArrSeat, setArrSeat, dataBookSeat, setDataBookSeat, count, setCounter, startpoint, endpoint }) => {
  const [list, setList] = useState(items);
  const [idSeat, setIdSeat] = useState([]);
  const [dataInforBook, setDataInforBook] = useState();
