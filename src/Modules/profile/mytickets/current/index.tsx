		...
		<Wrapper>
			<div className="block">
										...
										<>
											<div className="item flex ">
												...
												<div className="w-[40%]">
													...
													{item.nameSeat ? (
														<>
															<p className="font-bold ml-20 mt-8 ">
																Thanh toán ngay{" "}
															</p>
															<a
																href={
																...
																target="_blank"
																className="payment ml-20 mt-[-10px] pl-[20px]"
															>
																Thanh toán
															</a>
														</>
														...
														<>
															<p className="font-bold ml-20 mt-16 ">
																Thanh toán ngay
															</p>
															<a
																href={
				...
				{listHistory.length ? (
												...
												<div className="item flex ">
													<div className="w-[60%] ml-4">
														...
														<div className="flex mt-[-5px]">
															...
															<p>
																{item.historyBooking.dateStart.slice(
																	0,
																	10
																)}{" "}
															</p>
														...
														{item.historyBooking
															...
															<>
																<div className="flex">
																	...
																	<p className="font-bold ">
																		{item.historyBooking.nameSeat.slice(
																			0,
																			item
																				.historyBooking
																				.nameSeat
															...
															<>
																{item
																	...
																	<>
																		{" "}
																		<button
																			className="cancle ml-20 mt-16 pl-[36px]"
																			onClick={() =>
																				CancelTicket(
																					item
																						.historyBooking
																	...
																	<>
																		{" "}
																		<button
																			className="cancle ml-20 mt-24 pl-[36px]"
																			onClick={() =>
																				CancelTicket(
																					item
																						.historyBooking
					...
					<>
						<p className="">
							Bạn chưa có chuyến sắp đi nào,{" "}
							<span className="text-[#2a41e8] cursor-pointer">
								đặt vé ngay
							</span>
						</p>
					</>
